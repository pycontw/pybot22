INSERT INTO `pycon22`.`channel` (`channel_id`,`channel_name`,`welcome_msg`) VALUES ('1000406828024336435','service-desk','<:paw_stamp_pink:1010770490111033414> **收集「肉球印章」參加抽獎！**
> 回答贊助問題拿肉球印章，收集 5 個印章可參加抽獎，集越多中獎機會越高！
<:paw_stamp_pink:1010770490111033414> **Earn Pawprint Stamps to join the lucky draw!**
...
:money_with_wings:**賺「貓金幣」拿特殊獎勵 ! **
> 完成指定任務可獲得貓金幣，獲得金幣數前 10 名的參加者會得到特殊獎勵
:money_with_wings:** Earn PyCat coins to get the special reward! **
...
`  Mission list | 任務列表：`<#1000406828024336436>`  PS 回答贊助問題可獲得大量貓金幣  `
...
:star: 按下表情符號後將收到「PyCat」的私訊，首次遊玩請點選 :comet: 進行語言及隊伍設定
...
------------------- **links** -------------------
PyCon APAC Discord server  ：https://lihi2.cc/B5hqf
...
INSERT INTO `pycon22`.`channel` (`channel_id`,`channel_name`,`welcome_msg`) VALUES ('1008276066869186613','help','如果你對大地遊戲有任何疑問，歡迎在這個頻道提出！
（為維護遊戲體驗，請不要將答案傳到此頻道）
